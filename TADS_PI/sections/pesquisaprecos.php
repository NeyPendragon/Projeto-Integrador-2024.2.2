...
<div class="row">
  <div class="container-fluid">
    <h3 class="text-center text-secondary"> Encontre agora o melhor preço para o medicamento que você precisa na farmácia mais próxima do seu endereço! </h3>
</div>
</section>
...
<form action="" method="post" class="mt-3">
    ...
    <div class="mb-3">
        <label for="remedio" class="form-label">Digite o nome do remédio ou princípio ativo:</label>
        <input type="text" class="form-control border border-info" id="email" name="nomeremedio">
    </div>
    <div class="mb-3">
        <label for="tel" class="form-label">CEP (sem traços, somente números):</label>
        <input type="text" class="form-control border border-info" id="tel" name="telefonemedico">
    </div>
    <button type="submit" class="btn btn-primary mt-3 btn-lg"> <a href="listaprecos.php" class="text-white"> Pesquisar </a></button>
