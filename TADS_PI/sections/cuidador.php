    ...
    <div class="col d-flex justify-content-center">
      <div class="image-circle">
        <div class="circle-dashed ">
          <img src="../assets/img/mulher.png" alt="" class="circle-img" >
        </div>
      </div>
    </div>
  </div>
...
<section class="mt-40">
  <div class="container">
    <div class="alert alert-info fs-5" role="alert">
        <p> <strong> Nome: </strong> Suelen Cabral </p>
        <p> <strong> Telefone: </strong> <span class="material-symbols-outlined">call</span> (85) 3254-4514</p>
